...
| `docs/plans/ZOMBIE_ENGINE_MASTER_REFACTOR_PLAN_v8.0.md` | Authoritative Master Refactor Spec v8.2 (198 concrete features, 6 stages + 4 ports, supersedes v7.0). |
