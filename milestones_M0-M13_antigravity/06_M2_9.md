...
**Once Exit Criteria pass:** start a fresh Antigravity session/Task (context does not persist between sessions — only Rules do) and load the next file in sequence: `07_M3.md` (M3).
