# Prompt for Google Antigravity 2.0 — "The Endless Quarantine": Open-World Zombie Survival Engine, Full Rebuild M0 → M13 (v79)

## Changelog — v79 (merged ZombieEngine_Milestone_Gaps.md audit — 213 entries added, 12 duplicates dropped, 24 ID collisions renumbered)
Merged the 225-entry gap audit into the master doc as new "Gap-Closure Additions" subsections at the end of each affected milestone (M0, M1, M2, M2.7, M2.9, M3-M13 + subversions), zero edits to pre-existing text (verified byte-identical diff after stripping insertions). Source file claimed 200 entries / 0 duplicate IDs and 0 duplicate topics; independent audit found both claims false: 25 entries had colliding IDs reused across the two authoring passes (renumbered to free slots, e.g. old M6-001 -> M6-005), and 12 entries were full duplicates of content already present as existing EXT blocks (dropped: M0-EXT-25 Per-Fiber Containment, M0-EXT-24 Single-Instance Lock, M1-EXT-32 RayBatchQuery, M1-EXT-30 Parent-Child Hierarchy, M0-EXT-15 Action Map, M1-EXT-31 Camera Rig, M0-EXT-21 World-Epoch Clock, M0-EXT-28 Asset Checksum, M1-EXT-35 Telemetry Tap, M1-EXT-34 Localization String-Table, M1-EXT-38 Mod Write-Allowlist, M0-EXT-16 Determinism Guard). Net: 213 new entries merged. Post-merge: 238 total bracketed IDs, 0 duplicates, code fences balanced (986), 29 milestone headers intact.
...
## How to work this task (Google Antigravity 2.0 — Manager view, mixed model assignment)

**Model assignment (Antigravity 2.0 lets you assign a different model per agent/task — use this, don't run everything on one model):** assign **`REASONING_MODEL`** as the implementation agent for every milestone's actual engineering work — it's the tier with the deep-codebase-reasoning budget this doc's cross-system dependency chains (`BarrelHeat`, `SurfaceFrictionSample`, `StructuralFatigue`) need. Reserve **`FAST_MODEL`** for narrow, low-risk sub-tasks spawned off the main task — formatting a Task List Artifact, generating `STATUS.md`/`CHANGELOG.md` boilerplate, or drafting the Walkthrough Artifact write-up after the reasoning agent has already done the engineering. Never assign `FAST_MODEL` to a task that has to resolve a "Decisions to flag" checkpoint — fast models move quickly through a task list and will guess past a stop condition rather than actually stopping.

**Context does not persist between sessions in Antigravity — Rules do.** Unlike a tool with a persistent memory file, an Antigravity agent starts every new session cold; closing and reopening a Task loses anything you taught it through review comments. Before M0, write this document's non-negotiables into an Antigravity **Rule** (Settings → Rules, or a workspace `.antigravity/rules` file if your build supports it) — at minimum: YAGNI/one-liner-logic-solutions, CRLF line endings, versioned filenames, post-edit `grep` verification, and "every number in this doc is authoritative, not a suggestion." Rules apply automatically to every new Task; re-pasting this whole document at the top of every milestone Task is a fallback, not the primary mechanism.
...
4. **Build and run after every change — not just compile.** Confirm the fixed-timestep loop is stable. If headless, use `--headless` plus logged frame-time/tick output. Antigravity's own sandbox for this Task is a display-less remote Linux environment, so a "run" the agent performs there is a compile+headless-logic check at best — see item 5.
5. **Vulkan validation layers checked after every milestone. [Local-GPU verification required]** The agent's sandbox has no GPU/display, so it cannot produce a real validation log or RenderDoc capture itself. **Antigravity's Browser Subagent (Chrome-based click/screenshot verification) does not apply to this project** — this is a native Vulkan binary, not a web app, so there's no page for the browser agent to navigate. Any milestone touching rendering must instead have its validation-layer check and frame-time capture run on your actual RTX 2070 Super machine, with that log/screenshot pasted into the Walkthrough by you — the agent should say so explicitly rather than reporting a sandboxed "pass."
...
### Gap-Closure Additions — M0 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M0-001] Game Draw Path Bypasses Cull/Indirect (demo-only)
##### Systems Touched
...
## [M0-002] Hardcoded 100-Entity Cap
##### Math
-
##### Systems Touched
...
## [M0-003] Hi-Z Depth Pyramid Has No Producer
##### Math
-
##### Systems Touched
...
## [M0-004] Orphaned Staging / Frame-Deletion Systems
##### Math
-
##### Systems Touched
...
## [M0-005] No Async Shader Compile + Watchdog
##### Math
-
##### Systems Touched
...
## [M0-006] SoA Hot-Component Layout
##### Math
-
##### Systems Touched
...
## [M0-007] Meshlet / Mesh-Shader Pipeline
##### Math
-
##### Systems Touched
...
## [M0-008] Parallel Secondary Command-Buffer Recording
##### Math
-
##### Systems Touched
...
## [M0-009] Occlusion Query Double-Buffering
##### Math
-
##### Systems Touched
...
## [M0-010] Parallel-Deterministic PRNG Core
##### Systems Touched
...
## [M0-013] Frame-Deletion Queue Wiring
...
## [M0-014] GPU Validation in Release Builds
...
## [M0-015] Release Build Sanitizer Path
...
## [M0-016] Descriptor-Set Fragmentation Guard
...
## [M0-017] Secondary CB on Game Path
...
## [M0-018] Platform Support (Linux/macOS/console)
...
## [M0-019] Build & Packaging Pipeline
...
## [M0-020] Automated Test Matrix (unit/integration)
...
## [M0-021] Performance Budget & Profiling Dashboard
...
## [M0-023] Anti-Tamper & Memory Integrity
...
## [M0-024] Crash Reporter & Minidump Upload
...
## [M0-025] Analytics & Privacy-Consent
...
### Gap-Closure Additions — M1 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M1-001] SpatialHash Query Has No Gameplay Consumer
##### Math
-
##### Systems Touched
...
## [M1-004] EnTTCache Narrow Coverage
##### Math
-
##### Systems Touched
...
## [M1-007] Input-Rebinding Persistence
##### Math
-
##### Systems Touched
...
## [M1-008] M1 Exit Criteria Don't Reflect Reality
##### Math
-
##### Systems Touched
...
## [M1-009] EntityFactory Unknown-Component Warning
...
## [M1-010] Generational Table Headroom Check
...
## [M1-011] EnTTCache Round-Trip Test
...
## [M1-012] Action Map Persistence Format
...
## [M1-013] GPU Memory Budget & Defrag
...
## [M1-014] Shader Variant/Permutation Manager
...
### Gap-Closure Additions — M2 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M2-001] Character Controller / Player Movement
##### Math
-
##### Systems Touched
...
## [M2-003] Ballistics / Projectile Resolution
##### Math
-
##### Systems Touched
...
## [M2-004] Destructible = Placeholder Swap Only
##### Math
-
##### Systems Touched
...
## [M2-006] Hit/Limb Resolution Pipeline
##### Math
-
##### Systems Touched
...
## [M2-007] Physics Debug Draw (shipping toggle)
##### Math
-
##### Systems Touched
...
## [M2-008] No Real Content / Player / Zombie
##### Math
-
##### Systems Touched
...
## [M2-011] Survival Physiology (stamina/hunger)
...
## [M2-012] Crafting / Recipes / Workbench
...
## [M2-013] Skills / Perks / Progression
...
## [M2-014] Procedural Variation (bio-weight)
...
## [M2-015] Physics Determinism Test
...
### Gap-Closure Additions — M2.7 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M2.7-002] Reload Mechanics & Cancel
...
## [M2.7-006] Damage Types & Materials
...
### Gap-Closure Additions — M2.9 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M2.9-003] Body Temperature & Weather Exposure
...
## [M2.9-004] Encumbrance & Stamina Drain
...
### Gap-Closure Additions — M3 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M3-001] Terrain / World Geometry
##### Math
-
##### Systems Touched
...
## [M3-002] Streaming / LOD / Mip-Streaming
##### Math
-
##### Systems Touched
...
## [M3-003] Cascaded Shadow Map Decision
##### Math
-
##### Systems Touched
...
## [M3-004] Mipmap Generation on Load
##### Math
-
##### Systems Touched
...
## [M3-005] Post-Generation Sanity Checker
##### Math
-
##### Systems Touched
...
## [M3-006] Collision/Occlusion Sanity
##### Math
-
##### Systems Touched
...
## [M3-007] Navmesh Feasibility Check
##### Math
-
##### Systems Touched
...
## [M3-008] Loot/Spawn Density Sanity
##### Math
-
##### Systems Touched
...
## [M3-010] Mod Content Validator (V-section entry)
##### Math
-
##### Systems Touched
...
## [M3-011] Soft-Fail on Invalid Gen
##### Math
-
##### Systems Touched
...
## [M3-012] Generation Regression Corpus
##### Math
-
##### Systems Touched
...
## [M3-013] Degenerate-Triangle Filter
##### Math
-
##### Systems Touched
...
## [M3-015] Bounds/Extent Validator
##### Math
-
##### Systems Touched
...
## [M3-016] Duplicate-Entity Detector
##### Math
-
##### Systems Touched
...
## [M3-017] Validation Severity Levels
##### Math
-
##### Systems Touched
...
## [M3-020] Human-Readable Validation Report
##### Math
-
##### Systems Touched
...
## [M3-021] Macro-Destruction / Structural Graphs
...
## [M3-022] Foliage / Vegetation Scatter
...
## [M3-023] Texture Streaming Decision (VT vs mip)
...
## [M3-024] Material Permutation System
...
### Gap-Closure Additions — M4 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M4-001] Layer-Based Contextual Generation
##### Systems Touched
...
## [M4-003] Biome Blending at Borders
##### Systems Touched
...
## [M4-004] POI Placement Validator
##### Math
-
##### Systems Touched
...
## [M4-005] Loot/Encounter Table Compiler
##### Systems Touched
...
## [M4-006] Generation Seed Hierarchy
##### Systems Touched
...
## [M4-007] Stable Entity-ID per Chunk
##### Math
-
##### Systems Touched
...
## [M4-008] Archetype Seeded Variation Salt
##### Systems Touched
...
## [M4-009] Generation Budget Governor
##### Math
-
##### Systems Touched
...
## [M4-011] Biome→Asset Palette Binding
##### Math
-
##### Systems Touched
...
## [M4-012] Clutter/Scatter Generator
##### Math
-
##### Systems Touched
...
## [M4-013] Water/Liquid Volume Generator
##### Math
-
##### Systems Touched
...
## [M4-014] Cave/Underground Generator
##### Math
-
##### Systems Touched
M4. Vertical chunks.
...
## [M4-016] Generation Debug Visualization
##### Math
-
##### Systems Touched
...
## [M4-017] Multi-Resolution LOD Generation
##### Math
-
##### Systems Touched
...
## [M4-018] Procedural Sky/Starfield/Cloud
##### Math
-
##### Systems Touched
...
## [M4-019] Async Generation Off Main Thread
##### Math
-
##### Systems Touched
...
## [M4-020] Per-Frame Generation Budget
##### Systems Touched
...
## [M4-021] Prioritized Chunk Queue
##### Math
-
##### Systems Touched
...
## [M4-022] Pre-Generation Lookahead
##### Math
-
##### Systems Touched
...
## [M4-023] Generation Cancellation
##### Math
-
##### Systems Touched
...
## [M4-024] Chunk Generation State Machine
##### Math
-
##### Systems Touched
...
## [M4-025] Parallel Mesh/Collider Build
##### Math
-
##### Systems Touched
...
## [M4-026] Procedural Quest / Mission Generator
...
## [M4-027] Procedural Narrative / Dialogue Generator
...
## [M4-028] Difficulty / Tuning Curve Generator
...
## [M4-029] Generation RNG Replay File
...
## [M4-030] Generation Math Reduction Order
...
## [M4-031] Procedural Road/Path Network
...
## [M4-034] Procedural Encounter/Event Spawner
...
### Gap-Closure Additions — M5 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M5-001] AI Behavior / Utility System
##### Math
-
##### Systems Touched
...
## [M5-003] Procedural Animation (physics/IK)
##### Math
-
##### Systems Touched
...
## [M5-005] AI Director (horde pacing)
##### Math
-
##### Systems Touched
...
## [M5-006] Horde Emergence / Spawn Waves
...
## [M5-007] Zombie Facing / Emerge Animation
...
## [M5-009] Hearing Perception (radius+freq)
...
## [M5-010] Short-Term Memory & Investigation
...
## [M5-011] Horde Merge & Split Behavior
...
### Gap-Closure Additions — M6 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M6-001] Hardware-Accelerated Audio
##### Math
-
##### Systems Touched
...
## [M6-002] Audio Occlusion / Propagation
...
## [M6-003] Procedural Audio / VFX Params
...
## [M6-006] Occlusion/Obstruction Model
...
## [M6-004] Dynamic Music & Stinger System
...
### Gap-Closure Additions — M6.5 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M6.5-002] Blood & Gore Decals
...
## [M6.5-004] Weather Particle VFX (rain/snow)
...
### Gap-Closure Additions — M7 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M7-001] Save Compression (zstd)
##### Math
-
##### Systems Touched
...
## [M7-005] Save Corruption Recovery
...
## [M7-008] Save Encryption & Anti-Edit
...
## [M7-009] Backward-Save Compatibility
...
### Gap-Closure Additions — M8 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M8-001] Data-Driven Itemization
##### Math
-
##### Systems Touched
...
## [M8-003] Stacking & Inventory Slots
...
### Gap-Closure Additions — M8.5 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M8.5-002] Barter & Trade Economy
...
## [M8.5-003] Currency & Scarcity Model
...
### Gap-Closure Additions — M8.6 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M8.6-003] Settlement NPC Residents
...
### Gap-Closure Additions — M8.7 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M8.7-001] Perk Tree & Prerequisites
...
### Gap-Closure Additions — M9 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M9-001] Day/Night, Weather & Atmosphere
##### Math
-
##### Systems Touched
...
### Gap-Closure Additions — M10 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M10-001] HUD / UI Widgets
##### Math
-
##### Systems Touched
...
## [M10-002] Console / Command System
##### Math
-
##### Systems Touched
...
## [M10-004] Build / Packaging / Installer
##### Math
-
##### Systems Touched
...
## [M10-006] Spec↔Code Drift Checker
##### Math
-
##### Systems Touched
...
## [M10-007] Generation Debug Tooling (preview + seed explorer)
##### Math
-
##### Systems Touched
...
## [M10-008] Mod-Package / Workshop Tooling
##### Math
-
##### Systems Touched
...
## [M10-009] Generation Benchmark Suite
##### Math
-
##### Systems Touched
...
## [M10-010] HDR Swapchain Output Encoding
##### Systems Touched
...
## [M10-011] Tutorials / Contextual Hints
...
## [M10-012] Subtitles / Dialogue Display
...
## [M10-013] Minimap / Compass / Objective Tracker
...
## [M10-014] Achievements / Steam Integration
...
## [M10-015] Pause / Time-Scale System
...
### Gap-Closure Additions — M11 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M11-001] Three-Way Version Contract
##### Systems Touched
...
## [M11-002] Config Schema Registry
##### Math
-
##### Systems Touched
...
## [M11-003] Typed Parameter Handles
##### Math
-
##### Systems Touched
...
## [M11-004] Parameter Range/Clamp Enforcement
##### Math
-
##### Systems Touched
...
## [M11-006] Deliberate Mod API Surface
##### Math
-
##### Systems Touched
...
## [M11-007] ModAPI Semantic Versioning
##### Math
-
##### Systems Touched
...
## [M11-008] Mod Dependency Resolver
##### Math
-
##### Systems Touched
...
## [M11-009] Mod Incompatibility Detector
##### Math
-
##### Systems Touched
...
## [M11-010] Mod Checksum + Signature
##### Math
-
##### Systems Touched
...
## [M11-012] Runtime Mod Enable/Disable + Reload
##### Math
-
##### Systems Touched
...
## [M11-016] Mod Validation Pipeline Hook
##### Math
-
##### Systems Touched
...
## [M11-017] Mod Localization Hooks
##### Math
-
##### Systems Touched
...
## [M11-019] Mod Save-Namespace Isolation
##### Math
-
##### Systems Touched
...
## [M11-020] Benchmark / Perf HUD / Graphics Options
##### Math
-
##### Systems Touched
...
## [M11-021] Screen Shake / Hit Marker / Kill Feed
##### Systems Touched
...
## [M11-023] Mod Documentation Generator
...
## [M11-024] Workshop / Store Integration Stub
...
## [M11-031] Damage Numbers & Floating Text
...
## [M11-032] World Space UI (billboards)
...
### Gap-Closure Additions — M12 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M12-001] Networking / Netcode Transport
##### Math
-
##### Systems Touched
...
## [M12-002] Voice Chat / Push-To-Talk
##### Math
-
##### Systems Touched
...
## [M12-003] Anti-Cheat / Server Authority
##### Math
-
##### Systems Touched
...
## [M12-005] Matchmaking / Lobby / Session
...
## [M12-006] Lobby / Session Integrity
...
## [M12-004] Dedicated Server Model
...
### Gap-Closure Additions — M13 (merged from ZombieEngine_Milestone_Gaps.md audit; see AUDIT_MILESTONE_GAPS_MERGE.md)

## [M13-001] Offline SLM Generation Harness
##### Math
-
##### Systems Touched
...
## [M13-002] SLM Prompt-Template Library
##### Math
-
##### Systems Touched
...
## [M13-003] SLM Output Schema Validator
##### Math
-
##### Systems Touched
...
## [M13-004] SLM Output → Validation Pipeline
##### Math
-
##### Systems Touched
...
## [M13-006] SLM Deterministic Seeding
##### Math
-
##### Systems Touched
...
## [M13-007] SLM Fallback on Failure
##### Math
-
##### Systems Touched
...
## [M13-009] SLM Quest & Objective Text
...
## [M13-010] SLM Dialogue & Branching
...
## [M13-011] SLM Lore & Worldbuilding
...
## [M13-012] SLM Loadout/Build Suggestions
...
## [M13-013] SLM Moderation/Filtering
