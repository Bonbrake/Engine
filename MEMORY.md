...
## M2.7 GO-1 Merge (2026-07-18, THIS SESSION)
| Commit | Scope | Blocks |
|--------|-------|--------|
| `b030b81` | M2.7 core 17 combat blocks merged (navigation, threat response, combat, stealth, group tactics, horde coordination) | M2-EXT-82..97 (16 blocks) |
| `6a296b6` | M2-EXT-98 (Reload State Machine stub), M2-EXT-99 (Per-Material Damage Response stub), M2-EXT-100 (Decoupled View-Matrix Camera from EXT-14) | 3 blocks |

**Total M2.7 merged: 19 blocks** (user's "17 + EXT-19 + EXT-22" = 19, plus EXT-14 = 20 but EXT-14 was not in original 17; EXT-14 is a distinct camera block, NOT a duplicate of EXT-06 — archive confirms EXT-06 does not exist, EXT-14 is unique).

## REAL Remaining Work: 137 Provisional Archive Blocks
...
| M2.7 Core combat/melee/parry/gunplay | **23** | **19 merged (82-100), 4 remaining (EXT-18,20,21,31)** |
...
**Grand total remaining: 137** (132 + 4 M2.7 leftovers + 1 M1 STUB buffer)

### M1 STUBs (11 blocks, awaiting explicit GO)
M1-EXT-13 through M1-EXT-23 — placeholders in M1.md

### Other Open Items
- **vcpkg.json**: 17 exact version pins committed (Jolt 5.6.0, SDL3 3.4.12, etc.)
...
- 137 provisional blocks are the REAL scope; 23 committed blocks are done; 19 M2.7 blocks merged this session
...
- **Design synthesis written**: `recon/plans/2026-07-18_DESIGN-SYNTHESIS.md` — resolves 4 open decisions (horde cadence, 5th faction=Remnant, dual-axis alignment, indirect zombie influence)
- **Engine build verification**: NOT YET RUN — critical next step after commit