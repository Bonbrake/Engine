...
title: Procedural world generation + chunk streaming & culling
milestone: M4
ext_blocks: 71
clusters: 8
cross_file_deps: 12
...
> **meta** · depends-on: - · depended-by: M4-EXT-03
...
> **meta** · depends-on: - · depended-by: M4-EXT-05
...
#### [M4-EXT-04] Voronoi Chunk Seam Vertex Normal-Welding Post-Process
> **tags** · general
> **tl;dr** · Cleans up geometry seams left by M4's Layered Chunk Streaming Topology (Voronoi + WFC), specifically where independent chunks generate their own localized WF...
> **meta** · depends-on: - · depended-by: M4-EXT-05
...
#### [M4-EXT-05] Geometric Edge Seam Welding for LOD Transitions
> **tags** · LOD
> **tl;dr** · Declares the base "Geometric Edge Seam Welding for LOD" bullet. Runs downstream of [M4-EXT-02]'s meshlet decimation (welds the LOD boundary that decimation p...
> **meta** · depends-on: M4-EXT-02, M4-EXT-04 · depended-by: -
...
> **meta** · depends-on: - · depended-by: M4-EXT-13, M4-EXT-14, M4-EXT-16
...
> **meta** · depends-on: M4-EXT-12 · depended-by: M4-EXT-14
...
> **meta** · depends-on: M4-EXT-13, M4-EXT-12 · depended-by: M4-EXT-15, M4-EXT-17
...
#### [M4-EXT-15] Darcy's-Law Deep Aquifer Extension
> **tags** · general
> **tl;dr** · Extends [M10]'s existing 2D groundwater heightmap (shared flooding grid) — this does not replace it, it adds the sub-surface porous-flow term that grid was a...
> **meta** · depends-on: M4-EXT-14 · depended-by: -
...
#### [M4-EXT-16] Saint-Venant Generation-Time Hydraulic Erosion
> **tags** · general
> **tl;dr** · [M4-EXT-12]'s tectonic heightfield (input surface), [M10]'s runtime Saint-Venant flooding solver ([M10-EXT-01]) — this reuses that exact flux stencil at gene...
...
> **meta** · depends-on: M4-EXT-18, M4-EXT-14 · depended-by: M4-EXT-18, M4-EXT-20
...
> **meta** · depends-on: M4-EXT-17 · depended-by: M4-EXT-17
...
#### [M4-EXT-19] Anthropogenic Infrastructure Exclusion Splines
> **tags** · general
> **tl;dr** · Anthropogenic Infrastructure Exclusion Splines
> **meta** · depends-on: - · depended-by: -
> **ctx** · Anthropogenic Infrastructure Exclusion Splines

<a id="M4-EXT-20"></a>
#### [M4-EXT-20] WFC Adjacency Propagator
> **tags** · WFC
> **tl;dr** · M4 WFC. Propagates adjacency constraints during WFC so connected tile types stay consistent.
> **meta** · depends-on: M4-EXT-17 · depended-by: -
...
> **meta** · depends-on: - · depended-by: M4-EXT-88
