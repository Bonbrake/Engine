...
2. Heat transfers between adjacent cells via thermal conduction and convective wind vectors: $rac{\partial T}{\partial t} = lpha 
...
### [M3-EXT-104] Recast/Detour Real-Time NavMesh Carving
