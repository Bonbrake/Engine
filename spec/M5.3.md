...
> **M5.3 quick-index (9 EXT blocks).** Read ONLY the block(s) you need — each is self-contained.

<details><summary>M5.3 block index (click to expand)</summary>
...
> **meta** · depends-on: [M5.3-EXT-01] · depended-by: -
...
> **meta** · depends-on: [M5.3-EXT-02] · depended-by: -
...
> **meta** · depends-on: [M5.3-EXT-03] · depended-by: -
...
> **meta** · depends-on: [M5.3-EXT-04] · depended-by: -
...
> **meta** · depends-on: [M5.3-EXT-05] · depended-by: -
...
#### [M5.3-EXT-06] Volatile Scent-Suppression Atmospheric Aerosol Diffusion Grid
> **tags** · general
> **tl;dr** · Hardens M5.3's Atmospheric Gaussian Plume Scent Dispersion against active particulate layers — dense smoke from burning structures (M6.5 fire thermodynamics) or
> **meta** · depends-on: [M5.3-EXT-06], [M5.3-EXT-03], [M5.3-EXT-04], [M5.3-EXT-05] · depended-by: -
...
> **meta** · depends-on: [M5.3-EXT-07] · depended-by: -
...
> **meta** · depends-on: [M5.3-EXT-08], [M4.6-EXT-04], [M4.5-EXT-07] · depended-by: -
