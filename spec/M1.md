---
title: M1 — GPU-driven ECS framework
milestone: M1
ext_blocks: 42
clusters: 4
cross_file_deps: 536
...
> **M1 quick-index (42 EXT blocks).** Read ONLY the block(s) you need — each is self-contained.

<details><summary>M1 block index (click to expand)</summary>
...
#### [M1-EXT-01] SpatialHash Uniform Grid Cell Bucketing Engine
> **tags** · spatialhash
> **tl;dr** · Formalizes the exact hashing formula behind SpatialHash — the uniform grid primitive already declared as shared infrastructure and reused by M2.8 comms static, 
> **meta** · depends-on: — · depended-by: M1-EXT-23
> **ctx** · SpatialHash Uniform Grid Cell Bucketing Engine — Formalizes the exact hashing formula behind SpatialHash — the uniform grid primitive already declared as shared infrastructure and reused by M2.8 comms static, M5.4 horde crush, M8.6 power-grid conductance, M9-EXT-06 horde drag, M9-EXT-11 drafting, and M6.5 blood spatter density.
...
#### [M1-EXT-02] Generational Resource Table Pointer Validator
> **tags** · stableid
> **tl;dr** · Backs every StableId-based lookup declared in M2.6 and used throughout (EnTT Meta Entity Inspector, M7 persistence, M8-EXT-06 item instances).
> **meta** · depends-on: — · depended-by: —
> **ctx** · Generational Resource Table Pointer Validator — Backs every StableId-based lookup declared in M2.6 and used throughout (EnTT Meta Entity Inspector, M7 persistence, M8-EXT-06 item instances).
...
#### [M1-EXT-03] Multi-Threaded Command Pool Matrix
> **tags** · general
> **tl;dr** · Implements the "Command pool-per-thread strategy" bullet already declared in M0's Implementation Steps, sized against M0's EnkiTS worker count.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · Multi-Threaded Command Pool Matrix — Implements the "Command pool-per-thread strategy" bullet already declared in M0's Implementation Steps, sized against M0's EnkiTS worker count.
...
#### [M1-EXT-04] Frame-Scoped Deletion Queue
> **tags** · gpu, ecs
> **tl;dr** · Governs when any GPU resource (buffer, image, pipeline) created by M1's ECS framework is actually freed, across every later milestone that allocates GPU resourc
> **meta** · depends-on: — · depended-by: M1-EXT-06
> **ctx** · Frame-Scoped Deletion Queue — Governs when any GPU resource (buffer, image, pipeline) created by M1's ECS framework is actually freed, across every later milestone that allocates GPU resources.
...
#### [M1-EXT-05] Persistent-Mapped Staging Ring Buffer
> **tags** · rvt
> **tl;dr** · Backs the upload path for every per-frame dynamic write in the doc — bindless material updates, RVT page uploads (M4.5-EXT-07), UI buffers (M11).
> **meta** · depends-on: — · depended-by: —
> **ctx** · Persistent-Mapped Staging Ring Buffer — Backs the upload path for every per-frame dynamic write in the doc — bindless material updates, RVT page uploads (M4.5-EXT-07), UI buffers (M11).
...
#### [M1-EXT-06] EnTT Archetype Component SPSC Mutation Queue Committer
> **tags** · spsc, wfc
> **tl;dr** · Locks the concrete mechanism behind M1's base-step phrase "Single-threaded registry authority using SPSC ring buffers for background workers" — that phrase name
> **meta** · depends-on: M1-EXT-04, M2-EXT-01 · depended-by: M1-EXT-09, M1-EXT-53
> **ctx** · EnTT Archetype Component SPSC Mutation Queue Committer — Locks the concrete mechanism behind M1's base-step phrase "Single-threaded registry authority using SPSC ring buffers for background workers" — that phrase named the pattern but never specified it until now. Every background task that wants to add/remove a component or destroy an entity (async collision cook [M2-EXT-01], chunk streaming, WFC generation) must go through this queue instead of touching entt::registry from a worker thread.
...
#### [M1-EXT-07] Thread-Local Zero-Allocation Linear Page-Bump Arena
> **tags** · cpu, gpu, vma
> **tl;dr** · CPU-side scratch memory for short-lived per-tick arrays — pathfinding candidate lists, raycast hit buffers, visibility query results. Distinct from [M4.6-EXT-01
> **meta** · depends-on: M0-EXT-01, M2-EXT-03, M4.6-EXT-01 · depended-by: M1-EXT-09
> **ctx** · Thread-Local Zero-Allocation Linear Page-Bump Arena — CPU-side scratch memory for short-lived per-tick arrays — pathfinding candidate lists, raycast hit buffers, visibility query results. Distinct from [M4.6-EXT-01] (GPU vertex-buffer pooling) and [M0-EXT-01] (VMA cache-line alignment); this is the third consumer of that same alignment idiom, applied to plain CPU heap scratch instead of GPU sub-allocation.
...
#### [M1-EXT-08] Dynamic Spatial Hash Cell Quadtree Subdivision Splitter
> **tags** · general
> **tl;dr** · (stub) Dynamic Spatial Hash Cell Quadtree Subdivision Splitter — unfilled in source, body not yet authored.
> **meta** · depends-on: — · depended-by: M1-EXT-09
...
#### [M1-EXT-09] EnTT Concurrent Component Archetype View Iteration Cache
> **tags** · ecs
> **tl;dr** · Multi-threaded ECS system execution, background enkiTS worker fiber tasks.
> **meta** · depends-on: K-EXT-01, K-EXT-02, K-EXT-03, K-EXT-04, K-EXT-05, K-EXT-06, K-EXT-07, K-EXT-08, K-EXT-09, K-EXT-10, K-EXT-11, K-EXT-12, K-EXT-13, K-EXT-14, K-EXT-15, K-EXT-16, K-EXT-17, K-EXT-18, K-EXT-19, K-EXT-20, K-EXT-21, K-EXT-22, L-EXT-01, L-EXT-02, L-EXT-03, L-EXT-04, M0-EXT-01, M0-EXT-04, M0-EXT-08, M0-EXT-10, M0-EXT-11, M0-EXT-12, M0-EXT-14, M1-EXT-03, M1-EXT-06, M1-EXT-07, M1-EXT-08, M1-EXT-10, M1-EXT-11, M1-EXT-13, M1-EXT-15, M1-EXT-16, M1-EXT-17, M1-EXT-18, M1-EXT-19, M1-EXT-20, M1-EXT-21, M1-EXT-22, M1-EXT-23, M1-EXT-24, M1-EXT-25, M10-EXT-01, M10-EXT-02, M10-EXT-03, M10-EXT-04, M10-EXT-05, M10-EXT-06, M10-EXT-11, M11-EXT-01, M11-EXT-02, M11-EXT-03, M11-EXT-04, M11-EXT-05, M11-EXT-06, M11-EXT-07, M11-EXT-08, M11-EXT-09, M12-EXT-01, M12-EXT-02, M12-EXT-03, M12-EXT-04, M12-EXT-05, M12-EXT-07, M12-EXT-13, M13-EXT-01, M13-EXT-02, M13-EXT-03, M13-EXT-04, M13-EXT-05, M13-EXT-06, M13-EXT-07, M13-EXT-08, M13-EXT-09, M13-EXT-10, M13-EXT-11, M13-EXT-12, M13-EXT-13, M13-EXT-15, M2-EXT-02, M2-EXT-06, M2-EXT-07, M2.7-EXT-16, M2.7-EXT-17, M2.8-EXT-01, M2.8-EXT-02, M2.8-EXT-04, M2.8-EXT-05, M2.8-EXT-06, M2.8-EXT-07, M2.8-EXT-08, M2.9-EXT-01, M2.9-EXT-09, M2.9-EXT-10, M3-EXT-06, M3-EXT-08, M3-EXT-09, M4-EXT-01, M4-EXT-02, M4-EXT-03, M4-EXT-08, M4-EXT-09, M4-EXT-10, M4-EXT-11, M4-EXT-12, M4-EXT-13, M4-EXT-14, M4-EXT-15, M4-EXT-16, M4-EXT-17, M4-EXT-18, M4-EXT-19, M4-EXT-20, M4-EXT-21, M4-EXT-22, M4-EXT-23, M4-EXT-24, M4-EXT-25, M4-EXT-26, M4-EXT-27, M4-EXT-28, M4.5-EXT-01, M4.5-EXT-02, M4.5-EXT-03, M4.5-EXT-04, M4.5-EXT-05, M4.5-EXT-06, M4.5-EXT-07, M4.5-EXT-08, M4.5-EXT-09, M4.5-EXT-10, M4.5-EXT-11, M4.5-EXT-12, M4.5-EXT-13, M4.5-EXT-14, M4.5-EXT-15, M4.5-EXT-16, M4.5-EXT-17, M4.5-EXT-18, M4.5-EXT-19, M4.5-EXT-20, M4.5-EXT-21, M4.5-EXT-24, M4.5-EXT-25, M4.5-EXT-26, M4.5-EXT-27, M4.5-EXT-28, M4.5-EXT-29, M4.5-EXT-30, M4.5-EXT-31, M4.6-EXT-01, M4.6-EXT-02, M4.6-EXT-03, M4.6-EXT-04, M4.6-EXT-05, M4.6-EXT-06, M4.6-EXT-07, M4.6-EXT-08, M5-EXT-01, M5-EXT-02, M5-EXT-03, M5-EXT-04, M5-EXT-05, M5.1-EXT-01, M5.1-EXT-02, M5.1-EXT-03, M5.1-EXT-04, M5.1-EXT-05, M5.1-EXT-06, M5.1-EXT-07, M5.2-EXT-01, M5.2-EXT-02, M5.2-EXT-03, M5.2-EXT-04, M5.2-EXT-05, M5.2-EXT-06, M5.2-EXT-07, M5.2-EXT-08, M5.2-EXT-09, M5.2-EXT-10, M5.2-EXT-11, M5.2-EXT-12, M5.2-EXT-13, M5.2-EXT-14, M5.2-EXT-15, M5.3-EXT-01, M5.3-EXT-02, M5.3-EXT-03, M5.3-EXT-04, M5.3-EXT-05, M5.3-EXT-06, M5.3-EXT-07, M5.3-EXT-08, M5.4-EXT-01, M5.4-EXT-02, M5.4-EXT-03, M5.4-EXT-04, M5.4-EXT-05, M5.4-EXT-06, M5.4-EXT-07, M5.4-EXT-08, M5.4-EXT-09, M5.4-EXT-10, M6-EXT-01, M6-EXT-02, M6-EXT-03, M6-EXT-04, M6-EXT-05, M6-EXT-06, M6-EXT-07, M6-EXT-08, M6-EXT-09, M6-EXT-10, M6-EXT-11, M6-EXT-12, M6.5-EXT-01, M6.5-EXT-02, M6.5-EXT-03, M6.5-EXT-04, M6.5-EXT-05, M6.5-EXT-06, M6.5-EXT-07, M6.5-EXT-08, M6.5-EXT-09, M6.5-EXT-10, M6.5-EXT-11, M6.5-EXT-12, M6.5-EXT-13, M7-EXT-01, M7-EXT-02, M7-EXT-03, M7-EXT-04, M7-EXT-05, M7-EXT-06, M7-EXT-07, M7-EXT-08, M7-EXT-09, M7-EXT-10, M7-EXT-11, M8-EXT-01, M8-EXT-02, M8-EXT-03, M8-EXT-04, M8-EXT-05, M8-EXT-06, M8-EXT-07, M8-EXT-08, M8-EXT-09, M8-EXT-10, M8.5-EXT-01, M8.5-EXT-02, M8.5-EXT-03, M8.5-EXT-04, M8.6-EXT-01, M8.6-EXT-02, M8.6-EXT-03, M8.6-EXT-04, M8.6-EXT-05, M8.6-EXT-06, M8.6-EXT-07, M8.6-EXT-08, M8.6-EXT-09, M8.6-EXT-10, M9-EXT-01, M9-EXT-02, M9-EXT-03, M9-EXT-04, M9-EXT-05, M9-EXT-06, M9-EXT-07, M9-EXT-08, M9-EXT-09, M9-EXT-10, M9-EXT-11, M9-EXT-12, M9-EXT-13, M9-EXT-14, M9-EXT-15, M9-EXT-16, M9-EXT-17, M9-EXT-18, M9-EXT-19, M9-EXT-20, M9-EXT-21, M9-EXT-22 · depended-by: —
> **ctx** · EnTT Concurrent Component Archetype View Iteration Cache — Multi-threaded ECS system execution, background enkiTS worker fiber tasks.
...
#### [M1-EXT-10] Render-Graph Pass Dependency DAG Flattener *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · dag
> **tl;dr** · VERIFY)* — M1 render graph. Linearizes the pass DAG into a valid submit order respecting resource read/write edges.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · Render-Graph Pass Dependency DAG Flattener *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 render graph. Linearizes the pass DAG into a valid submit order respecting resource read/write edges.
...
#### [M1-EXT-11] Compute-to-Indirect-Draw Execution Barrier *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · gpu
> **tl;dr** · VERIFY)* — M1 + M2.6 GPU culling. Memory/execution barrier between compute culling and the indirect draw that consumes its buffer.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · Compute-to-Indirect-Draw Execution Barrier *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + M2.6 GPU culling. Memory/execution barrier between compute culling and the indirect draw that consumes its buffer.
...
> **meta** · depends-on: M1-EXT-29, M1-EXT-30, M1-EXT-31, M1-EXT-32, M1-EXT-33, M1-EXT-34, M1-EXT-35, M1-EXT-36, M1-EXT-37, M1-EXT-38, M10-EXT-02, M11-EXT-42, M12-EXT-01, M12-EXT-02, M12-EXT-03, M12-EXT-06, M12-EXT-23, M13-EXT-13, M13-EXT-14, M2.8-EXT-04, M2.8-EXT-05, M4.5-EXT-07, M4.6-EXT-01, M4.6-EXT-09, M5.2-EXT-08, M5.2-EXT-09, M5.2-EXT-16, M9-EXT-04 · depended-by: —
...
> **tl;dr** · VERIFY)*
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · Render-Graph Barrier Topological Sorter *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **STUB** · unfilled in source spec — no Systems Touched/Math/How It Works/Reference Implementation/Player-Facing Impact authored yet.
...
#### [M1-EXT-15] GPU Query Pool Timestamp Profiler *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · gpu
> **tl;dr** · VERIFY)* — M1. Timestamp queries via Vulkan query pool for GPU frame profiling.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · GPU Query Pool Timestamp Profiler *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1. Timestamp queries via Vulkan query pool for GPU frame profiling.
...
#### [M1-EXT-16] SoA Cache-Line Padding *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · ecs
> **tl;dr** · VERIFY)* — M1 ECS storage. Pads SoA component arrays to 64-byte cache lines to avoid false sharing / straddle.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · SoA Cache-Line Padding *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 ECS storage. Pads SoA component arrays to 64-byte cache lines to avoid false sharing / straddle.
...
#### [M1-EXT-17] Deterministic Secondary Command-Buffer Merger *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · general
> **tl;dr** · VERIFY)* — M1. Merges per-thread secondary command buffers into the primary in deterministic order.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · Deterministic Secondary Command-Buffer Merger *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1. Merges per-thread secondary command buffers into the primary in deterministic order.
...
#### [M1-EXT-18] Material-Batched Mesh-Pass Rendering *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · general
> **tl;dr** · VERIFY)* — M1 + M4.5. Batches draw calls by material to cut state changes.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · Material-Batched Mesh-Pass Rendering *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + M4.5. Batches draw calls by material to cut state changes.
...
#### [M1-EXT-19] SoA Layout for Hot Components *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · ecs
> **tl;dr** · VERIFY)* — M1 ECS. Hot components stored Structure-of-Arrays for cache-efficient iteration.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · SoA Layout for Hot Components *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 ECS. Hot components stored Structure-of-Arrays for cache-efficient iteration.
...
#### [M1-EXT-20] EnTT Group-Backed Hot-Component Storage *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · general
> **tl;dr** · VERIFY)* — M1 + EnTT. Uses EnTT groups for O(1) hot-component view iteration.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · EnTT Group-Backed Hot-Component Storage *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + EnTT. Uses EnTT groups for O(1) hot-component view iteration.
...
#### [M1-EXT-21] Buffer Device Address for Skinned-Mesh Animation Data *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · general
> **tl;dr** · VERIFY)* — M1 + M5.1. Exposes skinning bone matrices via buffer device addresses for shader direct-read.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · Buffer Device Address for Skinned-Mesh Animation Data *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + M5.1. Exposes skinning bone matrices via buffer device addresses for shader direct-read.
...
#### [M1-EXT-22] CVar System (ImGui-Backed) *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · imgui
> **tl;dr** · VERIFY)* — M1 + UI. Central console-variable registry with ImGui debug panel.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · CVar System (ImGui-Backed) *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + UI. Central console-variable registry with ImGui debug panel.
...
#### [M1-EXT-23] Timeline Semaphores for Multi-Queue Sync *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · general
> **tl;dr** · VERIFY)* — M1. Vulkan timeline semaphores sequence work across graphics/compute/transfer queues.
> **meta** · depends-on: M1-EXT-01, M2-EXT-01, M2-EXT-02, M2-EXT-03, M2-EXT-04, M2-EXT-05, M2-EXT-06, M2-EXT-07, M2.7-EXT-01, M2.7-EXT-02, M2.7-EXT-03, M2.7-EXT-04, M2.7-EXT-05, M2.7-EXT-06, M2.7-EXT-07, M2.7-EXT-08, M2.7-EXT-09, M2.7-EXT-10, M2.7-EXT-11, M2.7-EXT-12, M2.7-EXT-13, M2.7-EXT-14, M2.7-EXT-15, M2.7-EXT-16, M2.7-EXT-17, M2.8-EXT-01, M2.8-EXT-02, M2.8-EXT-03, M2.8-EXT-04, M2.8-EXT-05, M2.8-EXT-06, M2.8-EXT-07, M2.8-EXT-08, M2.8-EXT-09, M2.9-EXT-01, M2.9-EXT-02, M2.9-EXT-03, M2.9-EXT-04, M2.9-EXT-05, M2.9-EXT-06, M2.9-EXT-07, M2.9-EXT-08, M2.9-EXT-09, M2.9-EXT-10, M3-EXT-01, M3-EXT-02, M3-EXT-03, M3-EXT-04, M3-EXT-05, M3-EXT-06, M3-EXT-07, M3-EXT-08, M3-EXT-10, M3-EXT-11, M4-EXT-01, M4-EXT-02, M4-EXT-03, M4-EXT-04, M4-EXT-05, M4.5-EXT-04, M5.2-EXT-01, M7-EXT-01, M8-EXT-01 · depended-by: M1-EXT-09
> **ctx** · Timeline Semaphores for Multi-Queue Sync *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1. Vulkan timeline semaphores sequence work across graphics/compute/transfer queues.
...
### Cluster C — render graph / barriers
<a id="M1-EXT-24"></a>
#### [M1-EXT-24] Multi-Threaded Secondary Command Buffer Recording *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · general
> **tl;dr** · VERIFY)* — M1 + enkiTS. Records secondary command buffers across worker threads.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · Multi-Threaded Secondary Command Buffer Recording *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + enkiTS. Records secondary command buffers across worker threads.
...
#### [M1-EXT-25] Descriptor Update Templates for Per-Frame Bindless Writes *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · general
> **tl;dr** · VERIFY)* — M1 + M4.5 bindless. Writes descriptor sets via update templates for fast per-frame binds.
> **meta** · depends-on: — · depended-by: M1-EXT-09
> **ctx** · Descriptor Update Templates for Per-Frame Bindless Writes *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + M4.5 bindless. Writes descriptor sets via update templates for fast per-frame binds.
...
#### [M1-EXT-26] Chunk-Boundary Spatial-Hash Transfer *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · general
> **tl;dr** · VERIFY)* — M1 + M2.6. Transfers spatial-hash ownership across streaming chunk boundaries.
> **meta** · depends-on: — · depended-by: M1-EXT-53
> **ctx** · Chunk-Boundary Spatial-Hash Transfer *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + M2.6. Transfers spatial-hash ownership across streaming chunk boundaries.
...
#### [M1-EXT-27] Uniform-Grid Spatial Hash Broad-Phase *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · cpu, gpu
> **tl;dr** · VERIFY)* — M1 + M2.6. Uniform-grid broadphase as a CPU counterpart to GPU culling.
> **meta** · depends-on: — · depended-by: M1-EXT-53
> **ctx** · Uniform-Grid Spatial Hash Broad-Phase *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + M2.6. Uniform-grid broadphase as a CPU counterpart to GPU culling.
...
#### [M1-EXT-28] GPU Software Occlusion Rasterizer (HZB Feeder) *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)*
> **tags** · cpu, hzb
> **tl;dr** · VERIFY)* — M1 + M4.6-EXT-06. CPU-side rasterizes occluders into a HZB feeder for early occlusion.
> **meta** · depends-on: — · depended-by: M1-EXT-53
> **ctx** · GPU Software Occlusion Rasterizer (HZB Feeder) *(RECONSTRUCTED FROM CITATION CONTEXT — VERIFY)* — M1 + M4.6-EXT-06. CPU-side rasterizes occluders into a HZB feeder for early occlusion.
...
<a id="M1-EXT-39"></a>
#### [M1-EXT-39] SpatialHash Query Has No Gameplay Consumer
> **tags** · queryradius, querycell, spatialhash
...
### Cluster D — gpu features / occluders / msdf
<a id="M1-EXT-45"></a>
#### [M1-EXT-45] Input-Rebinding Persistence
> **tags** · general
...
#### [M1-EXT-52] Shader Variant/Permutation Manager
> **tags** · general
> **tl;dr** · M1. No variant manager.
> **meta** · depends-on: M10-EXT-12, M10-EXT-13, M10-EXT-14, M10-EXT-15, M10-EXT-16, M10-EXT-17, M10-EXT-18, M10-EXT-19, M10-EXT-20, M10-EXT-21, M10-EXT-22, M10-EXT-23, M10-EXT-24, M10-EXT-25, M10-EXT-26, M10-EXT-27, M10-EXT-28, M10-EXT-29, M11-EXT-10, M11-EXT-11, M11-EXT-12, M11-EXT-13, M11-EXT-14, M11-EXT-15, M11-EXT-16, M11-EXT-17, M11-EXT-18, M11-EXT-19, M11-EXT-20, M11-EXT-21, M11-EXT-22, M11-EXT-23, M11-EXT-24, M11-EXT-25, M11-EXT-26, M11-EXT-27, M11-EXT-28, M11-EXT-29, M11-EXT-30, M11-EXT-31, M11-EXT-32, M11-EXT-33, M11-EXT-34, M11-EXT-35, M11-EXT-36, M11-EXT-37, M11-EXT-38, M11-EXT-39, M11-EXT-40, M11-EXT-41, M12-EXT-14, M12-EXT-15, M12-EXT-16, M12-EXT-17, M12-EXT-18, M12-EXT-19, M12-EXT-20, M12-EXT-21, M12-EXT-22, M13-EXT-16, M13-EXT-17, M13-EXT-18, M13-EXT-19, M13-EXT-20, M13-EXT-21, M13-EXT-22, M13-EXT-23, M13-EXT-24, M13-EXT-25, M13-EXT-26, M13-EXT-27, M13-EXT-28, M2-EXT-08, M2-EXT-09, M2-EXT-10, M2-EXT-11, M2-EXT-12, M2-EXT-13, M2-EXT-14, M2-EXT-15, M2-EXT-16, M2-EXT-17, M2-EXT-18, M2-EXT-19, M2-EXT-20, M2-EXT-21, M2-EXT-22, M2-EXT-23, M2-EXT-24, M2-EXT-25, M2-EXT-26, M2-EXT-27, M2-EXT-28, M3-EXT-12, M3-EXT-13, M3-EXT-14, M3-EXT-15, M3-EXT-16, M3-EXT-17, M3-EXT-18, M3-EXT-19, M3-EXT-20, M3-EXT-21, M3-EXT-22, M3-EXT-23, M3-EXT-24, M3-EXT-25, M3-EXT-26, M3-EXT-27, M3-EXT-28, M3-EXT-29, M3-EXT-30, M3-EXT-31, M3-EXT-32, M3-EXT-33, M3-EXT-34, M3-EXT-35, M4-EXT-29, M4-EXT-30, M4-EXT-31, M4-EXT-32, M4-EXT-33, M4-EXT-34, M4-EXT-35, M4-EXT-36, M4-EXT-37, M4-EXT-38, M4-EXT-39, M4-EXT-40, M4-EXT-41, M4-EXT-42, M4-EXT-43, M4-EXT-44, M4-EXT-45, M4-EXT-46, M4-EXT-47, M4-EXT-48, M4-EXT-49, M4-EXT-50, M4-EXT-51, M4-EXT-52, M4-EXT-53, M4-EXT-54, M4-EXT-55, M4-EXT-56, M4-EXT-57, M4-EXT-58, M4-EXT-59, M4-EXT-60, M5-EXT-06, M5-EXT-07, M5-EXT-08, M5-EXT-09, M5-EXT-10, M5-EXT-11, M5-EXT-12, M5-EXT-13, M5-EXT-14, M5-EXT-15, M5-EXT-16, M6-EXT-13, M6-EXT-14, M6-EXT-15, M6-EXT-16, M6-EXT-17, M6-EXT-18, M6-EXT-19, M6-EXT-20, M6-EXT-21, M6-EXT-22, M7-EXT-12, M7-EXT-13, M7-EXT-14, M7-EXT-15, M7-EXT-16, M7-EXT-17, M7-EXT-18, M7-EXT-19, M8-EXT-11, M8-EXT-12, M8-EXT-13, M8-EXT-14, M8-EXT-15, M8-EXT-16, M8-EXT-17, M8-EXT-18, M9-EXT-23 · depended-by: —
> **ctx** · Shader Variant/Permutation Manager — M1. No variant manager.
...
#### [M1-EXT-53] (provisional) Chunk Boundary Entity Transfer Queue
> **tags** · spsc
> **tl;dr** · Sits on the general enkiTS scheduler (not Jolt's job system — two-scheduler rule). Consumes the sector/chunk streaming boundaries defined in M2.6 (sector size h
> **meta** · depends-on: K-EXT-22, M0-EXT-13, M0-EXT-30, M0-EXT-31, M0-EXT-32, M0-EXT-33, M0-EXT-34, M0-EXT-35, M0-EXT-36, M0-EXT-37, M0-EXT-38, M0-EXT-39, M0-EXT-40, M0-EXT-41, M0-EXT-42, M0-EXT-43, M0-EXT-44, M0-EXT-45, M0-EXT-46, M0-EXT-47, M0-EXT-48, M0-EXT-49, M0-EXT-50, M0-EXT-51, M0-EXT-52, M0-EXT-53, M0-EXT-54, M1-EXT-06, M1-EXT-26, M1-EXT-27, M1-EXT-28, M10-EXT-02, M10-EXT-03, M10-EXT-11, M12-EXT-01, M12-EXT-13, M13-EXT-54, M2.8-EXT-02, M2.8-EXT-04, M2.8-EXT-10, M3-EXT-11, M3-EXT-36, M4-EXT-02, M4-EXT-08, M4-EXT-09, M4-EXT-17, M4-EXT-18, M4-EXT-25, M4-EXT-27, M4-EXT-28, M4.5-EXT-13, M4.5-EXT-24, M4.5-EXT-26, M4.5-EXT-30, M4.5-EXT-31, M4.6-EXT-05, M4.6-EXT-08, M5.2-EXT-05, M5.2-EXT-08, M5.2-EXT-09, M5.2-EXT-15, M5.4-EXT-09, M5.4-EXT-10, M6-EXT-11, M6-EXT-12, M6.5-EXT-08, M6.5-EXT-11, M6.5-EXT-13, M7-EXT-10, M7-EXT-11, M8.6-EXT-09, M8.6-EXT-10, M9-EXT-04, M9-EXT-12, M9-EXT-15, M9-EXT-19, M9-EXT-22 · depended-by: —
> **ctx** · (provisional) Chunk Boundary Entity Transfer Queue — Sits on the general enkiTS scheduler (not Jolt's job system — two-scheduler rule). Consumes the sector/chunk streaming boundaries defined in M2.6 (sector size held fixed through M4, line 1196). Coordinates with M5.4 AI director (which owns spawn/despawn density) so a handoff doesn't fight the spawner. Reuses [M1-EXT-06]'s SPSC ring-buffer idiom (the verified §5.10 sanity suite uses the same shape) for the cross-sector handoff mailbox.
