...
> **meta** · depends-on: [M2-EXT-01] · depended-by: -
...
#### [M2-EXT-02] Jolt Physics Multi-Body Rigid Island Sleep Event Bus Bridge
> **tags** · general
> **tl;dr** · [M7-EXT-01] The Corpse-Pile Flattening Engine already says "When an EnTT ragdoll entity transitions to a sleep flag..." but M2 never declared the mechanism that
> **meta** · depends-on: [M2-EXT-02], [M7-EXT-01] · depended-by: -
...
#### [M2-EXT-03] Continuous Narrow-Phase Contact Point Query Collector Cache
> **tags** · general
> **tl;dr** · Sits in front of Jolt's narrow-phase query API, deduping redundant raycasts/sweeps fired by multiple systems in the same frame — melee parry ([M2.7-EXT-01]), AI
> **meta** · depends-on: [M2-EXT-03], [M2.7-EXT-01] · depended-by: -
> **ctx** · Continuous Narrow-Phase Contact Point Query Collector Cache -- Sits in front of Jolt's narrow-phase query API, deduping redundant raycasts/sweeps fired by multiple systems in the same frame — melee parry ([M2.7-EXT-01]), AI perception line-of-sight (M5.3), vault ledge-analysis (M2.9), and any SpatialHash-adjacent query that also needs a physical line trace.
...
#### [M2-EXT-04] Fixed-Timestep Mechanical Joint Constraint Kinetic Energy Clamper
> **tags** · general
> **tl;dr** · Hardening pass alongside [M5.2-EXT-01]'s Stable-PD reformulation. That feature stabilizes ragdoll joint *torque generation*; this clamper is a last-resort hard 
> **meta** · depends-on: [M2-EXT-04], [M5.2-EXT-01] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-05] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-06] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-07] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-08] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-09] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-10] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-11] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-12] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-13] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-14] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-15] · depended-by: -
...
#### [M2-EXT-16] Save/Load Layer
> **tags** · general
> **tl;dr** · M2/M7. grep serialize|SaveGame → 0. Plant SaveSchemaVersion+NetworkProtocolVersion (separate), atomic write (tmp→fsync→checksum→rename), user-data dir via Asset
> **meta** · depends-on: [M2-EXT-16] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-17] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-18] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-19] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-20] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-21] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-22] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-23] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-24] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-25] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-26] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-27] · depended-by: -
...
> **meta** · depends-on: [M2-EXT-28] · depended-by: -
