...
#### [M7-EXT-01] The Corpse-Pile Flattening Engine (Dynamic Static Hulls)
> **tags** · general
> **tl;dr** · Connects M7 total persistence body lifecycles directly to your M2.7 character virtual movement loops. Consumes [M2-EXT-02]'s HibernationEvent on the M2 Event...
...
#### [M7-EXT-04] Soft-Body Cloth, Tethered Rot-Cloth & Cosserat-Rod Vegetation (Jolt 5.6.0 Soft-Body Unlock)
> **tags** · general
> **tl;dr** · New capability unlocked by the Jolt 5.6.0 bump (item 8) — Jolt's XPBD-based soft-body system. Sits adjacent to M7's corpse-pile system (shares the same stati...
> **meta** · depends-on: - · depended-by: -
...
#### [M7-EXT-05] Perishable Item Decay & Cook-Safety Integral (Food Spoilage & Cooking)
> **tags** · general
> **tl;dr** · Reuses M7-EXT-02's existing Arrhenius material-decay formula (K_decay = A_humidity · e^(−E_a/(R·T_sector)), currently driving structural oxidation during chu...
> **meta** · depends-on: - · depended-by: -
...
#### [M7-EXT-06] Player-Facing Save Slot & Autosave UI Layer
> **tags** · UI
> **tl;dr** · Thin UI layer directly over the existing M7 StableId/Zstandard persistence engine, atomic file-swap, and rolling backup — zero new backend, purely the missin...
> **meta** · depends-on: - · depended-by: -
