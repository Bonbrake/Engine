...
> **meta** · depends-on: [M8.6-EXT-01] · depended-by: -
...
> **meta** · depends-on: [M8.6-EXT-02], [M8.6-EXT-04] · depended-by: -
...
> **meta** · depends-on: [M8.6-EXT-03], [M8.6-EXT-05], [M8.6-EXT-01], [M8.6-EXT-02] · depended-by: -
...
> **meta** · depends-on: [M8.6-EXT-04], [M8.6-EXT-02] · depended-by: -
...
#### [M8.6-EXT-05] Catenary Wire Clothesline Decapitation Loop
> **tags** · general
> **tl;dr** · Extends M8.6 wiring anchor blocks, setting clean Jolt distance constraints. Reuses the canonical CableSpanComponent and CheckCableSnap() declared in [M8.6-EXT-0
> **meta** · depends-on: [M8.6-EXT-05], [M8.6-EXT-03] · depended-by: -
...
#### [M8.6-EXT-06] Player-Placed Barricade Snap Constraints (Fortification)
> **tags** · general
> **tl;dr** · Reuses the exact CableSpanComponent/CheckCableSnap() pattern declared in [M8.6-EXT-03], adding a third CableRole::Barricade value rather than new constraint cod
> **meta** · depends-on: [M8.6-EXT-06], [M8.6-EXT-03] · depended-by: -
...
#### [M8.6-EXT-07] Kirchhoff Circuit Ohmic Dissipation Water Vaporization Solver
> **tags** · general
> **tl;dr** · Links M8.6's Kirchhoff power grid to M10's Saint-Venant shallow-water flooding grid — when a snapped live line ([M8.6-EXT-03]/[M8.6-EXT-05], CableSpanComponent)
> **meta** · depends-on: [M8.6-EXT-07], [M8.6-EXT-03], [M8.6-EXT-05], [M8.6-EXT-01], [M8.6-EXT-04] · depended-by: -
...
> **meta** · depends-on: [M8.6-EXT-08] · depended-by: -
...
> **meta** · depends-on: [M8.6-EXT-09] · depended-by: -
> **ctx** · Genetic-Algorithm Settlement Macro-Layout Optimizer
<a id="M8.6-EXT-10"></a>
#### [M8.6-EXT-10] Settlement NavMesh from GA Layout *(SOURCED FROM PLAN FILE)*
> **tags** · NavMesh, GA, SOURCED, FROM, PLAN, FILE
...
> **meta** · depends-on: [M8.6-EXT-10], [M4-EXT-09], [M5.4-EXT-06] · depended-by: -
