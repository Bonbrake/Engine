...
title: UI/HUD, input abstraction, haptics
milestone: M11
ext_blocks: 48
clusters: 5
cross_file_deps: 13
...
#### [M11-EXT-03] Raycast-Fan Fog-of-Reveal Navigation (Map/Minimap)
> **tags** · general
> **tl;dr** · M5.3's actual perception stack (SNR Detection Probability, Ray-Marched Foliage Concealment, Kalman-filtered Sensor Fusion) has no fan-cast sightline primitiv...
> **meta** · depends-on: - · depended-by: -
...
#### [M11-EXT-04] Diegetic Onboarding via Seeded Low-Severity Starter Outbreak
> **tags** · general
> **tl;dr** · Uses the existing M8 SEIR outbreak engine seeded at low severity in the player's starting settlement — teaching happens through the real systems at low stake...
> **meta** · depends-on: - · depended-by: -
...
#### [M11-EXT-05] OKLab-Driven Accessibility Suite (Colorblind, Captions, Remapping)
> **tags** · general
> **tl;dr** · Colorblind-safe palette remapping reuses the same perceptually-uniform OKLab pipeline already computing structural-stress visualization (C_stress, M3-EXT-02)...
> **meta** · depends-on: - · depended-by: -
...
#### [M11-EXT-06] Runtime String-Template Localization Pipeline
> **tags** · general
> **tl;dr** · Wraps Appendix A's procedural narrative/diary-entry generation in resolvable string templates from the point of generation, rather than post-processing alrea...
> **meta** · depends-on: - · depended-by: -
