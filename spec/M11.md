...
> **M11 quick-index (56 EXT blocks).** Read ONLY the block(s) you need — each is self-contained.
...
- `M5-EXT-10` AI Director actor-weight snapshot persistence (Thompson-Sampling weights) Register
