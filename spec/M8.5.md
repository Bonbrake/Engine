...
> **M8.5 quick-index (4 EXT blocks).** Read ONLY the block(s) you need — each is self-contained.

<details><summary>M8.5 block index (click to expand)</summary>
...
<a id="M8.5-EXT-07"></a>
#### [M8.5-EXT-07] Snare / Trap Detailing for Foraging
> **tags** · general
