...
##### How It Works
1. Sample local T, humidity. 2. Refract acoustic rays. 3. Scatter highs by humidity. 4. Feed reverb tail.
##### Reference Implementation
```cpp
float c=331.3f*sqrt(1.f+T/273.15f); float scatter=exp(-beta*f*d);
```
##### Player-Facing Impact
