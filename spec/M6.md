...
title: Procedural audio synthesis + spatial mix
milestone: M6
ext_blocks: 22
clusters: 4
cross_file_deps: 2
...
> **meta** · depends-on: - · depended-by: M6-EXT-07
...
#### [M6-EXT-05] Audio Voice Prioritization Matrix Allocation Weight Culler
> **tags** · general
> **tl;dr** · Sits under M6's Miniaudio backend decision, gating channel budget at horde scale — distinct from the propagation/Doppler/echo EXT features above, which shape...
> **meta** · depends-on: - · depended-by: M6-EXT-06
...
#### [M6-EXT-06] Variable-Rate Audio Emitter Execution Cadence Stagger Matrix
> **tags** · general
> **tl;dr** · Protects M6's 0.5ms audio execution budget alongside [M6-EXT-05]'s voice-priority culler — where that feature decides *whether* a voice mixes at all, this on...
...
#### [M6-EXT-07] Material-Indexed Velvet-Noise Late Reverb
> **tags** · general
> **tl;dr** · Declares the base "Material-Indexed Reverb. Velvet-Noise Late Reverb Synthesis" bullet. Reads room/surface material tags from [M6-EXT-04]'s voxelized propaga...
