...
2. Traces sound paths between source and listener, calculating material absorption loss: $	ext{Atten}_{	ext{dB}} = \sum d_i lpha_i$.
...
##### Implementation
1. Acoustic voxel grid assigns material absorption vectors $oldsymbol{lpha} = (lpha_{	ext{low}}, lpha_{	ext{mid}}, lpha_{	ext{high}})$.
