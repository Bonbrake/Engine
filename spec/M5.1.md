...
> **M5.1 quick-index (7 EXT blocks).** Read ONLY the block(s) you need — each is self-contained.

<details><summary>M5.1 block index (click to expand)</summary>
...
- `M5.1-EXT-07` Optimal Reciprocal Collision Avoidance (ORCA) Solver
...
> **meta** · depends-on: - · depended-by: M5.1-EXT-05
...
> **meta** · depends-on: - · depended-by: M5.1-EXT-04, M5.1-EXT-05
...
#### [M5.1-EXT-04] Anatomical Hit-Volume SDF Gradients
> **tags** · SDF
> **tl;dr** · Declares the base "Anatomical Hit-Volume SDF Gradients" bullet. Consumes [M5.1-EXT-03]'s Master Skeleton pose data (skinned vertex positions feed the SDF's z...
> **meta** · depends-on: M5.1-EXT-03 · depended-by: -
...
#### [M5.1-EXT-05] Heat-Diffusion Automatic Rigging & PSOLA Phenotype Vocalization
> **tags** · PSOLA
> **tl;dr** · Declares the base "Heat-Diffusion Automatic Rigging. Phenotype Vocalization Shift via PSOLA" bullet. Rigging half feeds [M5.1-EXT-03]'s Master Skeleton bindi...
> **meta** · depends-on: M5.1-EXT-03, M5.1-EXT-02 · depended-by: -
> **ctx** · Heat-Diffusion Automatic Rigging & PSOLA Phenotype Vocalization -- Declares the base "Heat-Diffusion Automatic Rigging. Phenotype Vocalization Shift via PSOLA" bullet. Rigging half feeds [M5.1-EXT-03]'s Master Skeleton binding; vocalization half feeds M6's audio propagation as the per-zombie emitter source, sharing PSOLA machinery with M6's [M6-EXT] voice pipeline rather than duplicating a pitch-shift implementation.
...
<a id="M5.1-EXT-09"></a>
#### [M5.1-EXT-09] Atmosphere Volumetric Scattering Pass
> **tags** · general
