...
> **meta** · depends-on: [M5.1-EXT-01] · depended-by: -
...
#### [M5.1-EXT-02] Player Character Generation (Uninfected-Mode Phenotype Pipeline)
> **tags** · general
> **tl;dr** · Runs the existing M5.1 zombie phenotype/bio-weight generator with the infection-mutation pass disabled — one canonical procedural humanoid generator for players
> **meta** · depends-on: [M5.1-EXT-02] · depended-by: -
...
#### [M5.1-EXT-04] Anatomical Hit-Volume SDF Gradients
> **tags** · SDF
> **tl;dr** · Declares the base "Anatomical Hit-Volume SDF Gradients" bullet. Consumes [M5.1-EXT-03]'s Master Skeleton pose data (skinned vertex positions feed the SDF's zero
> **meta** · depends-on: [M5.1-EXT-04], [M5.1-EXT-03] · depended-by: -
...
#### [M5.1-EXT-05] Heat-Diffusion Automatic Rigging & PSOLA Phenotype Vocalization
> **tags** · PSOLA
> **tl;dr** · Declares the base "Heat-Diffusion Automatic Rigging. Phenotype Vocalization Shift via PSOLA" bullet. Rigging half feeds [M5.1-EXT-03]'s Master Skeleton binding;
> **meta** · depends-on: [M5.1-EXT-05], [M5.1-EXT-03], [M5.1-EXT-02] · depended-by: -
...
> **meta** · depends-on: [M5.1-EXT-06] · depended-by: -
...
> **meta** · depends-on: [M5.1-EXT-07] · depended-by: -
