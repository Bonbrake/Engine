...
> **tags** · m2.9, system
> **tl;dr** · Body Temperature & Weather Exposure — M2-EXT-114.
> **ctx** · M2.9-EXT-13 — M2.9 traversal, ballistics & survival physiology.
> **meta** · depends-on: — · depended-by: -
...
- TBD: author specific failure modes.
...
> **tags** · m2.9, system
> **tl;dr** · Encumbrance & Stamina Drain — M2-EXT-115.
> **ctx** · M2.9-EXT-14 — M2.9 traversal, ballistics & survival physiology.
> **meta** · depends-on: — · depended-by: -
...
> **tags** · m2.9, system
> **tl;dr** · Boredom & Loneliness (Morale Need) — M2-EXT-116.
> **ctx** · M2.9-EXT-26 — M2.9 traversal, ballistics & survival physiology.
> **meta** · depends-on: — · depended-by: -
...
> **tags** · m2.9, system
> **tl;dr** · Realism-Fun Floor (Anti-Cumbersome Survival) — M2-EXT-117.
> **ctx** · M2.9-EXT-27 — M2.9 traversal, ballistics & survival physiology.
> **meta** · depends-on: — · depended-by: -
...
> **tags** · m2.9, system
> **tl;dr** · Foraging (Berries / Mushrooms, Skill-Gated Poison ID) — M2-EXT-118.
> **ctx** · M2.9-EXT-28 — M2.9 traversal, ballistics & survival physiology.
> **meta** · depends-on: — · depended-by: -
...
> **tags** · m2.9, system
> **tl;dr** · Ammo Crafting (Case Reform / Press) — M2-EXT-119.
> **ctx** · M2.9-EXT-29 — M2.9 traversal, ballistics & survival physiology.
> **meta** · depends-on: — · depended-by: -
...
> **tags** · m2.9, system
> **tl;dr** · Tripwire & Trigger Alarm — M2-EXT-120.
> **ctx** · M2.9-EXT-30 — M2.9 traversal, ballistics & survival physiology.
> **meta** · depends-on: — · depended-by: -
...
> **tags** · m2.9, system
> **tl;dr** · Sound Masking (Earplugs / Hearing Protection) — M2-EXT-121.
> **ctx** · M2.9-EXT-31 — M2.9 traversal, ballistics & survival physiology.
> **meta** · depends-on: — · depended-by: -
...
> **tags** · m2.7, system
> **tl;dr** · Cover Stability Sway Damper — M2-EXT-122.
> **ctx** · M2.7-EXT-18 — M2.7 weapon sway/recoil critical-damping transition.
> **meta** · depends-on: — · depended-by: -
Cover Stability Sway Damper
...
Braced-confidence never decays after breaking cover → wobble never returns.
zetaBraced < 1 (under-damped) → sway rings/overshoots on brace-in, reads as jitter.
b applied before clamp on zetaEff → negative ζ if b>1 → oscillator diverges (NaN).
...
> **tags** · m2.7, system
> **tl;dr** · Roll-Down Shutter / Window Cover — M2-EXT-123.
> **ctx** · M2.7-EXT-31 — M2.7 urban sight-block cover.
> **meta** · depends-on: — · depended-by: -
Roll-Down Shutter / Window Cover
...
shutterClosed flag desyncs from mesh state → zombies see through closed shutter or blocked when open.
Break() not gated by a damage threshold → shutter destroyed by incidental contact.
No LOS fallback when shutter open → interior still blocks sight incorrectly.
...
> **tags** · m2.9, system
> **tl;dr** · Sleep-Deprivation Hallucination Drift — M2-EXT-124.
> **ctx** · M2.9-EXT-11 — M2.9 fatigue/wakefulness scalar.
> **meta** · depends-on: — · depended-by: -
Sleep-Deprivation Hallucination Drift
...
SleepDebt not clamped → σ explodes, H saturates the clamp every frame (constant distortion).
H not persisted on save/load → hallucination state lost or corrupted across sessions.
theta = 0 (no reversion) → H random-walks unbounded before clamp, flickers at envelope edge.
...
> **tags** · m2.9, system
> **tl;dr** · Drowning & Underwater O2 — M2-EXT-125.
> **ctx** · M2.9-EXT-32 — M2.9 O2 reserve & drowning damage.
> **meta** · depends-on: — · depended-by: -
Drowning & Underwater O2
...
o2 refill rate too high → cannot drown while submerged (no water hazard).
ApplyDrowning not gated by !inWater → drowns on land after surfacing.
Swim stamina not consumed → underwater movement free, trivializes water risk.
...
> **tags** · m2.9, system
> **tl;dr** · Electric Fence (Base Defense) — M2-EXT-126.
> **ctx** · M2.9-EXT-33 — M2.9 perimeter fence stun/drain.
> **meta** · depends-on: — · depended-by: -
Electric Fence (Base Defense)

##### Systems Touched
M8.6-EXT-28 safehouse + M4 power + M3 destruction.

##### Math
I_shock = V_fence / R_contact;  // R_contact ~= 800 ohm dry, ~200 ohm wet; shock is CURRENT-mediated, not power
if(powered && touched && I_shock >= 0.075f) Stun(z, VF_LETHAL);
else if(powered && touched && I_shock >= 0.010f) Stun(z, I_shock*STUN_SCALE);
draw = watts*dt;
...
##### Examples
```cpp
if(powered && zombieTouch) {
    float iShock = vFence / rContact;
    if(iShock >= 0.075f) Stun(z, VF_LETHAL);
    else if(iShock >= 0.010f) Stun(z, iShock*stunScale);
}
fuel -= watts*dt;
```
...
R_contact swing (dry 800 ohm vs wet 200 ohm) ~= 4x current → accidental VF/kill when contact wet.
Stun() not scaled to I_shock magnitude → sub-threshold hits do nothing or over-stun.
Fuel draw not paused when unpowered → drains generator while switched off.
Player-exclusive check missing → player stunned by own fence.
...
> **tags** · m2.9, system
> **tl;dr** · Disease / Infection Contagion Spread — M2-EXT-127.
> **ctx** · M2.9-EXT-34 — M2.9 proximity-density contagion.
> **meta** · depends-on: — · depended-by: -
Disease / Infection Contagion Spread

##### Systems Touched
M2.9 illness + M5.4 bite + M5.4-EXT-17 karma + SLM world news.

##### Math
beta = R0 / (kappa * D);  // R0 = beta/gamma; kappa=contact rate, D=infectious duration
p = 1.0f - expf(-beta * density * (mask?0.3f:1.0f) * dt); if(rand()<p) Infect(target)
...
##### Examples
```cpp
float beta = R0 / (kappa * D);
float p = 1.0f - expf(-beta * density * (mask?0.3f:1.0f) * dt);
if(near(infected) && rand()<p) Contract(disease);
```

##### Failure Modes

p now dt-scaled via hazard form (1-exp(-beta*density*dt)); ensure kappa*D>0 to avoid div-by-zero.
Mask 0.3 factor applies globally → confirm it should also reduce bite transmission.
near() radius static → infects at any distance or never at the edge.
