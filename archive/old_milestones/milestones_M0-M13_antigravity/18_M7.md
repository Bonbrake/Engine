...
## Appendix Cross-References for M7

*The following items from the doc's Appendices/§5.x Addenda explicitly reference M7 in their "Systems Touched" or scope. Auto-matched by milestone ID — verify relevance before feeding to Antigravity.*
...
**Once Exit Criteria pass:** load the next milestone file in sequence: `19_M8.md` (M8).
...
#### [M7-EXT-08] Save Compression (zstd)
...
#### [M7-EXT-09] Asset Checksum Integrity
...
#### [M7-EXT-10] Telemetry Tap + Consent Gate
...
#### [M7-EXT-11] Localization / Accessibility String-Table
...
#### [M7-EXT-12] Save Corruption Recovery
...
#### [M7-EXT-14] Save Encryption & Anti-Edit
...
#### [M7-EXT-15] Backward-Save Compatibility
